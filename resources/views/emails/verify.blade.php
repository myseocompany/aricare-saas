                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            {{ __('messages.new_change.hello') . '!' }}</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('messages.new_change.click_the_button_below_to_verify_your_email_address') }}
                                        </p>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="{{ $url }}"
                                                                                ...
                                                                                {{ __('messages.new_change.verify_email_address') }}</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('messages.new_change.if_you_did_not_create_an_account') }}</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('messages.new_change.thanks_regards') }}<br>
                                            {{ config('app.name') }}</p>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        {{ __('messages.new_change.trouble', [
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ date('Y') }} {{ getSuperAdminAppName() }}. All rights reserved.
                                        </p>
                                    </td>
                                </tr>
                            </table>
