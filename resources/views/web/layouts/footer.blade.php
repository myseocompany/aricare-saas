                ...
                <ul class="ps-0" style="{{App::getLocale() == 'ar' ? 'padding-right: 0' : ''}}">
                    <li>
                        <a href="{{ route('front', $user->username) }}"
                            class="{{ Route::currentRouteName() == 'front' ? 'footer-active' : '' }} text-decoration-none mb-3 d-block text-white">
                            {{ __('messages.web_home.home') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('our-services', $user->username) }}"
                            class="{{ Route::currentRouteName() == 'our-services' ? 'footer-active' : '' }} text-decoration-none mb-3 d-block text-white">
                            {{ __('messages.web_home.services') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('our-doctors', $user->username) }}"
                            class="{{ Route::currentRouteName() == 'our-doctors' ? 'footer-active' : '' }} text-decoration-none mb-3 d-block text-white">
                            {{ __('messages.web_home.doctors') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('aboutUs', $user->username) }}"
                            class="{{ Route::currentRouteName() == 'aboutUs' ? 'footer-active' : '' }} text-decoration-none mb-3 d-block text-white">
                            {{ __('messages.web_menu.about') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('contact', $user->username) }}"
                            class="{{ Route::currentRouteName() == 'contact' ? 'footer-active' : '' }} text-decoration-none mb-3 d-block text-white">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="footer-info">
                    ...
                    <div class="d-flex align-items-center footer-info__block mb-3 pb-1">
                        <i
                            class="fa-solid fa-phone text-white fs-5 {{ App::getLocale() == 'ar' ? 'ms-3' : 'me-3' }}"></i>
                    ...
                    <div class="d-flex align-items-center footer-info__block mb-3 pb-1">
                        <i
                            class="fa-solid fa-clock fs-5 text-white {{ App::getLocale() == 'ar' ? 'ms-3' : 'me-3' }}"></i>
                    ...
                    <div class="d-flex align-items-center footer-info__block mb-3 pb-1">
                        <i
                            class="fa-solid fa-location-dot fs-5 text-white {{ App::getLocale() == 'ar' ? 'ms-3' : 'me-3' }}"></i>
                        <p class="text-white fs-6 mb-0">
                            {{ $hospitalSettingValue['hospital_address']['value'] }}
                        </p>
                    </div>
                    <div class="d-flex align-items-center footer-info__block mb-3 pb-1">
                        <a href="{{ route('landing-home') }}" type="submit" data-turbo="false"
                            class="btn btn-primary">{{ __('messages.new_change.back_to_main_site') }}</a>
                    </div>
                </div>
            </div>
            <div class="col-12 text-center mt-lg-5 mt-4 copy-right">
                <p class="pt-4 pb-4 mb-0 text-white">
                    {{ __('messages.web_menu.copyright') }} © {{ date('Y') }}
                    {{ __('messages.web_menu.all_rights_reserved_by') }}
