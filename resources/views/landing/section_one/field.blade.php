<div class="row">
    <div class="form-group col-sm-6 mb-5">
        <div class="row2">
            <label class="form-label" for="about_us_image"> <span>{{ __('messages.landing_cms.image') }}: </span>
            ...
            <div class="d-block">
                ...
                <div class="image-picker">
                    <div class="image previewImage" id="exampleInputImage"
                        style="background-image: url({{ isset($sectionOne['img_url']) ? asset($sectionOne['img_url']) : asset('web_front/images/doctors/doctor.png') }})">
                    </div>
