    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        ?>
                        <div class="row2">
                            <label class="form-label d-flex" for="about_us_image">
                            ...
                            <div class="d-block">
                                <div class="image-picker">
                                    <div class="image previewImage" id="exampleInputImage"
                                        style="background-image: url({{ asset('web_front/images/doctors/doctor.png') }})">
                                    </div>
            ...
            <div class="modal-footer pt-0">
                ...
                <button type="button"
                    class="btn btn-secondary my-0 ms-5 {{ getLoggedInUser()->language === 'ar' ? 'me-5' : 'me-0' }} "
