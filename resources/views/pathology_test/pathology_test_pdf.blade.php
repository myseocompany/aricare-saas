                        ...
                        <div class="col-md-4 co-12 mt-md-0 mt-5">
                            <table class="table w-100">
                                ...
                                <tr class="">
                                    ...
                                    <td class="text-end fs-5 text-gray-800">
                                        {{ $data['pathologyTest']['test_name'] ?? __('messages.common.n/a') }}
                                    </td>
                                </tr>
                                <tr class="">
                                    <td class="">
                                    ...
                                    <td class="text-end fs-5 text-gray-800">
                                        {{ $data['pathologyTest']['test_type'] ?? __('messages.common.n/a') }}
                                    </td>
                                </tr>
                                <tr class="">
                                    <td class="">
                                    ...
                                    <td class="text-end fs-5 text-gray-800">
                                        {{ $data['pathologyTest']['short_name'] ?? __('messages.common.n/a') }}
                                    </td>
                                </tr>
                                <tr class="">
                                    <td class="">
                                    ...
                                    <td class="text-end fs-5 text-gray-800">
                                        {{ $data['pathologyTest']['method'] ?? __('messages.common.n/a') }}
                                    </td>
                                </tr>
                                <tr class="">
                                    <td class="">
                                    ...
                                    <td class="text-end fs-5 text-gray-800">
                                        {{ $data['pathologyTest']->chargecategory->name ?? __('messages.common.n/a') }}
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    color:#2c3e50;">
                        <table class="table w-100">
                            <tr class="">
                                ...
                                <td class="text-end fs-5 text-gray-800">
                                    {{ $data['pathologyTest']->pathologycategory->name ?? __('messages.common.n/a') }}
                                </td>
                            </tr>
                            <tr class="">
                                <td class="">
                                ...
                                <td class="text-end fs-5 text-gray-800">
                                    {{ $data['pathologyTest']->unit ?? __('messages.common.n/a') }}
                                </td>
                            </tr>
                            <tr class="">
                                <td class="">
                                ...
                                <td class="text-end fs-5 text-gray-800">
                                    {{ $data['pathologyTest']->report_days ?? __('messages.common.n/a') }}
                                </td>
                            </tr>
                            <tr class="">
                                <td class="">
                                ...
                                <td class="text-end fs-5 text-gray-800">
                                    {{ $data['pathologyTest']->standard_charge ?? __('messages.common.n/a') }}
                                </td>
                            </tr>
                            <tr class="">
                                <td class="">
                                ...
                                <td class="text-end fs-5 text-gray-800">
                                    {{ $data['pathologyTest']->subcategory ?? __('messages.common.n/a') }}
                                </td>
                            </tr>
                        </table>
                    </td>
