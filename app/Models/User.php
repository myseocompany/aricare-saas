 ...
 */
class User extends Authenticatable implements HasMedia, MustVerifyEmail, HasName, HasAvatar, FilamentUser
{
    ...
    const COLLECTION_PROFILE_PICTURES = 'profile';
    ...
    const LANGUAGES_IMAGE = [
        'ar' => 'front-assets/img/iraq.svg',
        'zh' => 'front-assets/img/china.svg',
        'en' => 'front-assets/img/united-states.svg',
        'fr' => 'front-assets/img/france.svg',
        'de' => 'front-assets/img/germany.svg',
        'pt' => 'front-assets/img/portugal.svg',
        'ru' => 'front-assets/img/russia.svg',
        'es' => 'front-assets/img/spain.svg',
        'tr' => 'front-assets/img/turkey.svg',
    ];
     ...
     * @var array
     */
    protected $appends = ['full_name', 'age', 'profile', 'hospital_profile'];
    ...
    {
        return $this->hasOne(UserTenant::class)->ofMany([], function ($query) {
    ...
    public function getHospitalProfileAttribute(): string
    {
        if (empty($this->getFirstMediaUrl(self::COLLECTION_PROFILE_PICTURES))) {
            return '';
        }
